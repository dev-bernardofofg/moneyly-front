  ...
  return (
    <div className="dark:bg-slate-700 bg-slate-100 border dark:border-slate-600 border-slate-300 rounded-lg p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        {goal.isActive && <CheckCircle className="size-5 text-green-400" />}
      </div>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-sm">
            <span className="text-green-400 font-medium">
              {FN_UTILS_NUMBERS.formatCurrencyToNumber(goal.currentAmount)}
            </span>
            <span className="text-slate-400">{FN_UTILS_NUMBERS.formatCurrencyToNumber(goal.targetAmount)}</span>
          </div>
        </div>
        ...
        <div className="bg-slate-600 p-2 rounded-lg flex items-center justify-between">
          <div className="text-sm text-slate-400">Faltam</div>
