...
import {
  InitialConfigDefaultValues,
  InitialConfigFormValues,
  InitialConfigSchema,
} from '@/app/(resources)/(schemas)/initial-config.schema';
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-info">
                ...
                <p className="text-info/80">
                  Defina em qual dia do mês seu período financeiro começa e termina. Pode cruzar
                  meses (ex: do dia 5 ao dia 4 do próximo mês).
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 dark:bg-gray-800 dark:border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 dark:text-white/40">
                  Dia 1 ao 31: Período mensal completo
                </span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-info rounded-full"></div>
                <span className="text-gray-700 dark:text-white/40">
                  Dia 5 ao 4: Cruza meses (5 jan - 4 fev)
                </span>
              </div>
              <div className="flex items-center gap-2">
