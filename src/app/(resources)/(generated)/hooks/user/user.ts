...
export const getPutUserFinancialPeriodMutationOptions = <
  TError = PutUserFinancialPeriod400 | PutUserFinancialPeriod401,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PutUserFinancialPeriodMutationError =
  | PutUserFinancialPeriod400
  | PutUserFinancialPeriod401;
 ...
 * @summary Atualizar período financeiro
 */
export const usePutUserFinancialPeriod = <
  TError = PutUserFinancialPeriod400 | PutUserFinancialPeriod401,
  TContext = unknown,
>(
  options?: {
...
export const getPutUserIncomeAndPeriodMutationOptions = <
  TError = PutUserIncomeAndPeriod400 | PutUserIncomeAndPeriod401,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PutUserIncomeAndPeriodMutationError =
  | PutUserIncomeAndPeriod400
  | PutUserIncomeAndPeriod401;
 ...
 * @summary Atualizar renda + período
 */
export const usePutUserIncomeAndPeriod = <
  TError = PutUserIncomeAndPeriod400 | PutUserIncomeAndPeriod401,
  TContext = unknown,
>(
  options?: {
...
export type GetUserFinancialPeriodsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getUserFinancialPeriods>>
>;
export type GetUserFinancialPeriodsQueryError =
  | GetUserFinancialPeriods400
  | GetUserFinancialPeriods401;
...
export type GetUserFinancialPeriodsPeriodIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getUserFinancialPeriodsPeriodId>>
>;
export type GetUserFinancialPeriodsPeriodIdQueryError =
  | GetUserFinancialPeriodsPeriodId400
  | GetUserFinancialPeriodsPeriodId401
  | GetUserFinancialPeriodsPeriodId404;
