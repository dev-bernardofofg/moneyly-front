...
export const getPutBudgetsIdMutationOptions = <
  TError = PutBudgetsId400 | PutBudgetsId401 | PutBudgetsId404,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getDeleteBudgetsIdMutationOptions = <
  TError = DeleteBudgetsId400 | DeleteBudgetsId401 | DeleteBudgetsId404,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteBudgetsIdMutationError =
  | DeleteBudgetsId400
  | DeleteBudgetsId401
  | DeleteBudgetsId404;
