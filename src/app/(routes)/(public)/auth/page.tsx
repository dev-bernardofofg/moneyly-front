  ...
  return (
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-30 px-4">
        <Card className="dark:bg-slate-800/95 dark:border-slate-700/50 dark:shadow-black/20 bg-white/95 backdrop-blur-xs border border-slate-200/50 shadow-slate-900/10">
          <CardHeader className="text-center space-y-4 pb-8">
            <StaggeredFade>
              <Logo className="w-full" />
              <div className="space-y-2">
                <CardTitle className="text-3xl font-bold transition-colors duration-300 dark:text-white text-slate-800">
                  Moneyly
                </CardTitle>
                <CardDescription className="text-base transition-colors duration-300 dark:text-slate-400 text-slate-600">
