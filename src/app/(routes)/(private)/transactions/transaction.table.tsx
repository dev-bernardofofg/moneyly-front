    ...
    <BaseTable data={transactions}
      ...
      actions={(item) => (
        <div className="flex items-center gap-2">
          ...
          <ConfirmActionForm onConfirm={() => mutate({ id: item.id || '' })} title="Remover transação" description="Tem certeza que deseja remover esta transação?" trigger={
